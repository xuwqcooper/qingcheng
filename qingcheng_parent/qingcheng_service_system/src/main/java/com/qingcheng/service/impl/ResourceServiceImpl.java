...
import com.qingcheng.entity.RoleVO;
...
public class ResourceServiceImpl implements ResourceService {
    ...
    public List<Map> findAllResource() {
        ...
        List<Map> mapList = findAllResourceByParentId(resourceList, 0);
        return mapList;
    }

    private List<Map> findAllResourceByParentId(List<Resource> resourceList, Integer parentId) {
        ...
        for (Resource resource : resourceList) {
            if (resource.getParentId().equals(parentId)) {
                ...
                map.put("children", findAllResourceByParentId(resourceList, resource.getId()));
                maps.add(map);
            }
        }
        return maps;
