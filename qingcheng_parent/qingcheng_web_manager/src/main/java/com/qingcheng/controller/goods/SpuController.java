...
public class SpuController {
    ...
    @PostMapping("/autid.do")
    public Result autid(@RequestBody Map<String, String> map) {
        spuService.autid(map.get("id"),map.get("status"),map.get("message"));
        return new Result();
    }
